...
<body>
    <header>
        <nav class="navbar">
            <a href="../../index.php" class="logo"><img src="../../image/club-boxe-logo.jpg"></a>
        ...
        <main id="boxe-francaise">
            ...
            <div class="block-haut">
                ...
                <img src="../../image/boxe1.jpg" id="activity-kick-boxing">
            </div>

            <article class="block-histoire">
                <h2>L'histoire du Kick boxing</h2>
            ...
            <div class="block-enseignant">
                ...
                <div class="blocks-img-enseignant">
                   <div class="blocks-img-enseignant1">
                        <h3>John Doe</h3>
                        <img src="../../image/professeur-homme.png">
                   ...
                   <div class="blocks-img-enseignant2">
                    <h3>Jane Doe</h3>
                    <img src="../../image/professeur-femme.png">
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos 
                        sed est nostrum amet accusantium eligendi dolores enim et dolor eius.</p>
                    </div>
                    <div class="blocks-img-enseignant3">
                        <h3>Done John</h3>
                        <img src="../../image/anonyme3.jpg">
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos 
                            sed est nostrum amet accusantium eligendi dolores enim et dolor eius.</p>
                        </div>
                </div>

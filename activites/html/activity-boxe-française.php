...
<body>
    <header>
        <nav class="navbar">
            <a href="../../index.php" class="logo"><img src="../../image/club-boxe-logo.jpg" alt="blason"></a>
        ...
        <main id="boxe-francaise">
            ...
            <div class="block-haut">
                <h1>La boxe Française</h1>
                <div class="little-divider"></div>
                <figure>
                    <img src="../../image/kick boxing.jfif" alt="Photo boxe Française">
                </figure>
            </div>

            <article class="block-histoire">
                <h2>L'histoire de la boxe française</h2>
            ...
            <div class="block-enseignant">
                ...
                <div class="blocks-img-enseignant">
                   <div class="blocks-img-enseignant1">
                        <h3>John Doe</h3>
                        <figure>
                            <img src="../../image/professeur-homme.png" alt="entraineur boxe Française">
                        </figure>
                   ...
                   <div class="blocks-img-enseignant2">
                    <h3>Jane Doe</h3>
                    <figure>
                        <img src="../../image/professeur-femme.png" alt="entraineur boxe Française">
                    </figure>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos 
                        sed est nostrum amet accusantium eligendi dolores enim et dolor eius.</p>
                    </div>

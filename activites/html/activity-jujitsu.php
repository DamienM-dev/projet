    ...
    <header>
        ...
        <main id="boxe-francaise">
            ...
            <div class="block-haut">
                ...
                <figure><img src="../../image/JIUJITSU.jpg" alt="cours de Jiu Jitsu"></figure>
            </div>

            <article class="block-histoire">
                <h2>L'histoire du Jiu Jitsu</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Error, quasi. 
                    ...
                    Magni error eos fugiat tempore quibusdam atque, sunt at delectus iste.
                     ...
                     <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti cum adipisci, 
                        aliquam praesentium, 
                        modi iusto quidem harum aliquid, magni mollitia molestias sunt architecto! Dicta 
                        provident porro, aut voluptate sunt minima illo repudiandae odio ad quasi iure 
                        commodi, possimus odit minus reprehenderit consequatur at aliquid suscipit dolorem 
                        reiciendis officia? Est odit necessitatibus cumque aut aspernatur debitis eum quia 
                        laborum quaerat minus?</p>
            </article>
            ...
            <div class="block-enseignant">
                ...
                <div class="blocks-img-enseignant">
                   <div class="blocks-img-enseignant1">
                        <h3>John Doe</h3>
                        <figure>
                            <img src="../../image/professeur-homme.png" alt="Photo du professeur ">
                        </figure>
                   ...
                   <div class="blocks-img-enseignant2">
                    <h3>Jane Doe</h3>
                    <figure><img src="../../image/anonyme3.jpg" alt="Photo du professeur "></figure>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos 
                        sed est nostrum amet accusantium eligendi dolores enim et dolor eius.</p>
                    </div>
                </div>

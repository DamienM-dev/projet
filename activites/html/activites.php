        ...
        <section id="cards-activity">
            ...
            <article class="card-activity">
                <div class="style-card">
                    <div class="card-flip-gestion">
                        <div class="card">
                            <img src="../../image/boxe1.jpg" style="width: 300px; height: 300px;" alt="Photo kick boxing">
                            <h2>Kick boxing</h2>
                        </div>
                        <div class="flip-card-back">
                            <a href="activity-kick-boxing.php"><h2>Kick boxing</h2></a>
            ...
            <article class="card-activity">
                <div class="style-card">
                    <div class="card-flip-gestion">
                        <div class="card">
                            <img src="../../image/boxe2.jpg" style="width: 300px; height: 300px;" alt="photo grappling">
                            <h2>grappling</h2>
                        </div>
                        <div class="flip-card-back">
                            <a href="activity-grappling.php"><h2>grappling</h2></a>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque quod veritatis 
                            sequi inventore amet corporis quibusdam animi maiores dignissimos pariatur?</p>
                        </div>
                    </div>
            ...
            <article class="card-activity">
                <div class="style-card">
                    <div class="card-flip-gestion">
                        <div class="card">
                            <img src="../../image/boxe3.jpg" style="width: 300px; height: 300px;" alt="photo pancrace">
                            <h2>Pancrace</h2>
                        </div>
                        <div class="flip-card-back">
                            <a href="activity-pancrace.php"><h2>Pancrace</h2></a>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque quod veritatis 
                            sequi inventore amet corporis quibusdam animi maiores dignissimos pariatur?</p>
                        </div>
                    </div>
            ...
            <article class="card-activity">
                <div class="style-card">
                    <div class="card-flip-gestion">
                        <div class="card">
                            <img src="../../image/JUDO.jpg" style="width: 300px; height: 300px;" alt="photo judo">
                            <h2>Judo</h2>
                        </div>
                        <div class="flip-card-back">
                            <a href="activity-judo.php"><h2>judo</h2></a>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque quod veritatis 
                            sequi inventore amet corporis quibusdam animi maiores dignissimos pariatur?</p>
                        </div>
                    </div>
            ...
            <article class="card-activity">
                <div class="style-card">
                    <div class="card-flip-gestion">
                        <div class="card">
                            <img src="../../image/JIUJITSU.jpg" style="width: 300px; height: 300px;" alt="photo jiu jitsu">
                            <h2>Jiu Jitsu</h2>
                        </div>
                        <div class="flip-card-back">
                            <a href="activity-jujitsu.php"><h2>jui jitsu</h2></a>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque quod veritatis 
                            sequi inventore amet corporis quibusdam animi maiores dignissimos pariatur?</p>
                        </div>
                    </div>
